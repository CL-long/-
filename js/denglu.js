$(function () {
    ...
    if (getCookie("username")) {
        $(".yonghuming").val(getCookie("username"))
        $(".mima").val(getCookie("password"))
        var qitian = document.querySelector(".gouxuan")
        qitian.checked = true;

    } else if (getCookie("anhao") == 1) {
        $(".yonghuming").val(getCookie("yh"));
    ...
    $(".xieyi").click(function () {
        ...
        if ($(".yonghuming").val() == "" || $(".mima").val() == "") {
            ...
            if ($(".gouxuan").is(":checked") == true) {
                setCookie("username", $(".yonghuming").val(), 7)
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.code == 1) {
                        localStorage.setItem("yonghu", $(".yonghuming").val());
