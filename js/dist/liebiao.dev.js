    ...
    $.ajax({
      ...
      success: function success(res) {
        ...
        res.data.forEach(function (v) {
          html += "<a href=\"../html/xiangqingye.html?product_id=".concat(v.pid, "\"><figure>\n                        <figcaption><img src=\"").concat(v.pimg, "\" alt=\"\" /></figcaption>\n                          <div class=\"lb_miaoshu\">\n                            <div class=\"ms_top\">\n                              <h3><img src=\"../images/019_flag.jpg\" alt=\"\"><p>United&nbsp;States <br>\u7F8E\u56FD\u54C1\u724C</p></h3>\n                              <ul class=\"daojishi\">\n                                <li>\u8DDD\u7ED3\u675F\u8FD8\u5269</li> \n                                <li>00</li>\n                                <li>\u5929</li>\n                                <li></li>\n                                <li>\u65F6</li>\n                                <li></li>\n                                <li>\u5206</li>\n                                <li></li>\n                                <li>\u79D2</li>\n                              </ul>\n                            </div>\n                            <!-- \u63CF\u8FF0 -->\n                            <div class=\"ms_bottom\">\n                              <b>").concat(v.pname, "</b>\n                              <p>").concat(v.pdesc, "</p>\n                              <h5><span>\uFFE5</span>").concat(v.pprice, "<span>\u5305\u90AE</span></h5>\n                           \n                              <div class=\"ca_xq\"></div>\n                            </div>\n                          </div>\n                        </figcaption>\n                      </figure></a>");
        });
        $(".sp_lb").html(html);
...
if (localStorage.getItem("yonghu")) {
  ...
  var woid = localStorage.getItem("u-id");
  var wodeqian = localStorage.getItem("".concat(woid));
